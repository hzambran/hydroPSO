...
- **State-of-the-art PSO variants**, including support for **SPSO-2011**
  and **SPSO-2007**
- A **model-independent architecture** for both R-based and externally
  executed models
...
- A workflow suited to **research, teaching, and applied environmental
  modelling**
...
Zambrano-Bigiarini, M. and Rojas, R. (2020). **hydroPSO: Particle Swarm
Optimisation, with Focus on Environmental Models**. R package version
0.5-1. <https://doi.org/10.5281/zenodo.1287350>
...
hydroPSO solves a common scientific problem: how to calibrate complex
environmental models **without locking yourself into a single model
family or rewriting code you already trust**.
...
engine, hydroPSO remains a strong foundation.
