---
title: "Types of parameter changes"
output: rmarkdown::html_vignette
vignette: >
  %\VignetteIndexEntry{Parameter change types in hydroPSO}
...
Inspired by the community of the [SWAT](https://swat.tamu.edu/) and [SWAT+](https://swat.tamu.edu/software/plus/) hydrological models, since v.6-0 `hydroPSO` allows making parameter updates in three different ways, both for R-based and R-external models: 
...
![Three parameter-change modes in hydroPSO](../man/figures/change-type-parameter-updates.png)
...
2) Mixed types of parameter changes can be specified by using individual values for the `change.type` argument:
