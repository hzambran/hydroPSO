...
vignette: >
  %\VignetteIndexEntry{R-external models in hydroPSO}
...
![Workflow for calibrating R-external environmental models with hydroPSO](../man/figures/r-external-model-workflow.png)
